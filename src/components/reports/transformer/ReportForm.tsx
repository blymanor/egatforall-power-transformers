...
const ReportForm: React.FC<ReportFormProps> = ({
  ...
  return (
    <div className="space-y-8">
      {/* First section - Report criteria */}
      <div>
        <h3 className="text-black font-bold mb-6">เลือกเงื่อนไขในการสร้างรายงาน</h3>
      ...
      {/* Second section - Grouping selection */}
      <div>
        <h3 className="text-black font-bold mb-6">เลือกการแบ่งกลุ่ม (แบ่งตาม)</h3>
        <div className="flex items-center gap-4">
