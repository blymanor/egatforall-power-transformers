...
const OLTCCompartmentModal: React.FC<OLTCCompartmentModalProps> = ({
  isOpen,
  onClose,
  mode,
  data
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          <DialogTitle>
            {mode === "add" ? "เพิ่มข้อมูล OLTC Compartment" : 
             mode === "view" ? "ดูข้อมูล OLTC Compartment" : 
             "แก้ไขข้อมูล OLTC Compartment"}
          </DialogTitle>
        </DialogHeader>
