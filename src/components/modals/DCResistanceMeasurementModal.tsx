...
const DCResistanceMeasurementModal = ({ isOpen, onClose, mode, data }: DCResistanceMeasurementModalProps) => {
  const [formData, setFormData] = useState({
    ...
    hvPhaseA: mode === 'create' ? '0.0' : (data?.hvPhaseA || '0.0'),
    hvPhaseB: mode === 'create' ? '0.0' : (data?.hvPhaseB || '0.0'),
    hvPhaseC: mode === 'create' ? '0.0' : (data?.hvPhaseC || '0.0'),
    hvAverage: mode === 'create' ? '0.0' : (data?.hvAverage || '0.0'),
    hvMaxError: mode === 'create' ? '0.0' : (data?.hvMaxError || '0.0'),
    hvDeviation: mode === 'create' ? '0.0' : (data?.hvDeviation || '0.0'),
    // LV WINDING DC Resistance
    lvPhaseA: mode === 'create' ? '0.0' : (data?.lvPhaseA || '0.0'),
    lvPhaseB: mode === 'create' ? '0.0' : (data?.lvPhaseB || '0.0'),
    lvPhaseC: mode === 'create' ? '0.0' : (data?.lvPhaseC || '0.0'),
    lvAverage: mode === 'create' ? '0.0' : (data?.lvAverage || '0.0'),
    lvMaxError: mode === 'create' ? '0.0' : (data?.lvMaxError || '0.0'),
    lvDeviation: mode === 'create' ? '0.0' : (data?.lvDeviation || '0.0'),
    // TV WINDING DC Resistance
    tvPhaseA: mode === 'create' ? '0.0' : (data?.tvPhaseA || '0.0'),
    tvPhaseB: mode === 'create' ? '0.0' : (data?.tvPhaseB || '0.0'),
    tvPhaseC: mode === 'create' ? '0.0' : (data?.tvPhaseC || '0.0'),
    tvAverage: mode === 'create' ? '0.0' : (data?.tvAverage || '0.0'),
    tvMaxError: mode === 'create' ? '0.0' : (data?.tvMaxError || '0.0'),
    tvDeviation: mode === 'create' ? '0.0' : (data?.tvDeviation || '0.0'),
  });
