...
interface TwoWindingInsulationModalProps {
  isOpen: boolean;
  onClose: () => void;
...
const TwoWindingInsulationModal = ({ isOpen, onClose, mode, data }: TwoWindingInsulationModalProps) => {
          ...
          <div className="space-y-6">
            ...
            <div className="border rounded-lg p-4 space-y-4">
              ...
              <div className="grid grid-cols-4 gap-4">
                ...
                <div className="space-y-2">
                  <div className="text-center text-blue-600 font-medium">WDG. ENERGIZE : H1H0/H1H2</div>
                  <div className="text-center text-blue-600">WDG. SHORT : X1X0/X1X2</div>
                ...
                <div className="space-y-2">
                  <div className="text-center text-blue-600 font-medium">WDG. ENERGIZE : H2H0/H2H3</div>
                  <div className="text-center text-blue-600">WDG. SHORT : X2X0/X2X3</div>
                  <div className="grid grid-cols-3 gap-1 text-center text-xs text-blue-600">
                    <span>(V.)</span>
                    <span>(A.)</span>
                    <span>Z</span>
                ...
                <div className="space-y-2">
                  <div className="text-center text-blue-600 font-medium">WDG. ENERGIZE : H3H0/H3H1</div>
                  <div className="text-center text-blue-600">WDG. SHORT : X3X0/X3X1</div>
                  <div className="grid grid-cols-3 gap-1 text-center text-xs text-blue-600">
                    <span>(V.)</span>
                    <span>(A.)</span>
                    <span>Z</span>
              ...
              <div className="grid grid-cols-4 gap-4">
                <div className="space-y-2">
                  <Label className="text-blue-600">TAP</Label>
                  <Label className="text-blue-600 text-sm">COMMISSIONING OR FIRST TEST :</Label>
                  <Label className="text-blue-600 text-sm">%DEVIATION</Label>
                </div>
            ...
            {/* Similar sections for other energize configurations */}
            ...
            {/* BETWEEN ENERGIZE : (L-T) */}
            <div className="border rounded-lg p-4 space-y-4">
              <h3 className="text-lg font-semibold text-blue-600">BETWEEN ENERGIZE : (L-T)</h3>
...
export default TwoWindingInsulationModal;
