...
const ArresterModal = ({ isOpen, onClose, mode, data }: ArresterModalProps) => {
  ...
  const handleCalculate = () => {
    toast.success("คำนวณเสร็จสิ้น", {
      description: "ระบบได้คำนวณค่า Arrester แล้ว",
    });
  };
      ...
      <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
        ...
        <div className="space-y-6 p-4">
          ...
          <div className="space-y-4">
            <h3 className="text-lg font-semibold text-blue-600">Arrester Test Data</h3>
            <div className="grid grid-cols-3 gap-4">
              <Input placeholder="Arrester Property 1" readOnly={isReadOnly} />
              <Input placeholder="Arrester Property 2" readOnly={isReadOnly} />
              <Input placeholder="Arrester Property 3" readOnly={isReadOnly} />
            </div>
          </div>
