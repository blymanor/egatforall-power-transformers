...
const SinglePhaseImpedanceMeasurementModal = ({ 
  isOpen, 
  onClose, 
  mode,
  data 
}: SinglePhaseImpedanceMeasurementModalProps) => {
  ...
  const handleSave = () => {
    toast({
      ...
      description: "ข้อมูล Single Phase Impedance Measurement ถูกบันทึกเรียบร้อยแล้ว",
    });
    onClose();
  };
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="max-w-6xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          <DialogTitle>
            {mode === "add" && "เพิ่มข้อมูล Single Phase Impedance Measurement"}
            {mode === "edit" && "แก้ไขข้อมูล Single Phase Impedance Measurement"}
            {mode === "view" && "ดูข้อมูล Single Phase Impedance Measurement"}
          </DialogTitle>
        </DialogHeader>
        ...
        <div className="space-y-6 p-4">
          ...
          <div className="space-y-4">
                ...
                <table className="w-full border border-gray-300">
                  <thead>
                    ...
                    <tr className="bg-blue-50">
                      <th className="border border-gray-300 p-2">WDG. SHORT : X1X0/X1X2</th>
                      <th className="border border-gray-300 p-2">WDG. SHORT : X2X0/X2X3</th>
                      <th className="border border-gray-300 p-2">WDG. SHORT : X3X0/X3X1</th>
                      <th className="border border-gray-300 p-2">WDG. SHORT : X1X0/X1X2</th>
                      <th className="border border-gray-300 p-2">WDG. SHORT : X2X0/X2X3</th>
                      <th className="border border-gray-300 p-2">WDG. SHORT : X3X0/X3X1</th>
                      <th className="border border-gray-300 p-2">WDG. SHORT : X1X0/X1X2</th>
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td className="border border-gray-300 p-2">
                        <div className="flex flex-col gap-1">
                          <span className="text-red-500 font-semibold">WDG.</span>
                          <span className="text-red-500 font-semibold">TAP</span>
                        </div>
                      </td>
                      {Array.from({ length: 9 }, (_, i) => (
                        <td key={i} className="border border-gray-300 p-2">
                    ...
                    <tr>
                      <td className="border border-gray-300 p-2">
                        <div className="flex flex-col gap-1">
                          <span className="text-blue-600 font-semibold">COMMISSIONING OR FIRST TEST :</span>
                          <Select value="COMMISSIONING" disabled={isReadonly}>
                            <SelectTrigger className="w-32 h-8">
                              <SelectValue />
                            </SelectTrigger>
                          </Select>
                          <span className="text-blue-600 font-semibold">%DEVIATION</span>
                        </div>
                      </td>
                      {Array.from({ length: 9 }, (_, i) => (
                        <td key={i} className="border border-gray-300 p-2">
            ...
            {/* Additional sections would follow similar pattern for (H-L), (H-L), (H-T), and (L-T) */}
