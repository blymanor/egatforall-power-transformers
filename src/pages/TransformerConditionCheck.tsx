...
const TransformerConditionCheck = () => {
  ...
  const handleActivate = () => {
    ...
    console.log("Checking transformer condition:", transformer);
    console.log("Available data:", transformerData[transformer]);
    
    setIsActivated(true);
    toast({
      title: "ตรวจสอบสภาพหม้อแปลงไฟฟ้าสำเร็จ",
      description: `ตรวจสอบสภาพหม้อแปลงไฟฟ้า ${transformer} เรียบร้อยแล้ว`,
    });
  };
  ...
  return (
    <DashboardLayout>
      <div className="p-4 md:p-6 space-y-6 bg-[#f0f4fa]">
        <div className="mb-8">
          <h2 className="text-2xl font-semibold text-gray-800">ตรวจสอบสภาพหม้อแปลงไฟฟ้า</h2>
          <p className="text-lg text-gray-600">เลือกหม้อแปลงไฟฟ้าและตรวจสอบสภาพการทำงาน</p>
        </div>
            ...
            <div className="space-y-8">
              ...
              {transformer ? (
                ...
                <div className="bg-gray-50 p-6 rounded-lg text-center text-lg text-gray-500">
                  กรุณาเลือกหม้อแปลงไฟฟ้าเพื่อตรวจสอบสภาพ
                </div>
              )}
            </div>
          </CardContent>
...
export default TransformerConditionCheck;
