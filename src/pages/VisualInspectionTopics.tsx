...
const VisualInspectionTopics = () => {
  ...
  const visualInspectionTopics: VisualInspectionTopic[] = [
    { id: 1, no: 1, name: "CORROSION", testType: "General Condition" },
    { id: 2, no: 2, name: "OIL FAIL", testType: "Main Tank" },
    { id: 3, no: 3, name: "OIL LEVEL", testType: "Conservator Tank" },
    { id: 4, no: 4, name: "JEL COLOR", testType: "General Condition" },
    { id: 5, no: 5, name: "BREATHER", testType: "Conservator Tank" },
    { id: 6, no: 6, name: "LOAD", testType: "General Condition" },
    { id: 7, no: 7, name: "SOUND", testType: "General Condition" },
    { id: 8, no: 8, name: "VIBRATION", testType: "General Condition" },
    { id: 9, no: 9, name: "GROUND CONNECTOR", testType: "General Condition" },
    { id: 10, no: 10, name: "FOUNDATION", testType: "General Condition" },
    { id: 11, no: 11, name: "TANK CORROSION", testType: "Main Tank" },
    { id: 12, no: 12, name: "PRESSURE", testType: "Main Tank" },
  ];
                ...
                <TableBody>
                  {currentItems.map((item) => (
                    <TableRow key={item.id} className="even:bg-gray-50">
                      ...
                      <TableCell className="text-center">{item.testType}</TableCell>
