...
const SubComponentWeight = () => {
  ...
  return <DashboardLayout>
      <div className="p-6">
                ...
                <TableBody>
                  {currentItems.map(item => <TableRow key={item.id} className="even:bg-gray-50">
                      ...
                      <TableCell className="text-center">
                        <Button onClick={() => handleEdit(item)} variant="ghost" size="icon" className="hover:bg-blue-100">
        ...
        <SubComponentWeightModal isOpen={modalState.isOpen} onClose={closeModal} mode={modalState.mode} data={modalState.data} />
      </div>
    </DashboardLayout>;
};
